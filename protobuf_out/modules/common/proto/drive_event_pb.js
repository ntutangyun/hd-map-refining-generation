...
goog.exportSymbol('proto.apollo.common.DriveEvent', null, global);
goog.exportSymbol('proto.apollo.common.DriveEvent.Type', null, global);
/**
...
proto.apollo.common.DriveEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    location: (f = msg.getLocation()) && modules_localization_proto_pose_pb.Pose.toObject(includeInstance, f),
...
proto.apollo.common.DriveEvent.fromObject = function(obj) {
  ...
  obj.location && jspb.Message.setWrapperField(
      msg, 3, modules_localization_proto_pose_pb.Pose.fromObject(obj.location));
