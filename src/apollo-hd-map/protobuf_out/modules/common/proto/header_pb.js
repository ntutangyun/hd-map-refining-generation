...
goog.exportSymbol('proto.apollo.common.Header', null, global);
/**
...
proto.apollo.common.Header.fromObject = function(obj) {
  ...
  obj.status && jspb.Message.setWrapperField(
      msg, 8, modules_common_proto_error_code_pb.StatusPb.fromObject(obj.status));
...
proto.apollo.common.Header.prototype.getStatus = function() {
  return /** @type{?proto.apollo.common.StatusPb} */ (
    jspb.Message.getWrapperField(this, modules_common_proto_error_code_pb.StatusPb, 8));
};
