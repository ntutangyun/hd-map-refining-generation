...
goog.exportSymbol('proto.apollo.common.VehicleState', null, global);
/**
...
proto.apollo.common.VehicleState.fromObject = function(obj) {
  ...
  obj.pose && jspb.Message.setWrapperField(
      msg, 15, modules_localization_proto_pose_pb.Pose.fromObject(obj.pose));
...
proto.apollo.common.VehicleState.prototype.getPose = function() {
  return /** @type{?proto.apollo.localization.Pose} */ (
    jspb.Message.getWrapperField(this, modules_localization_proto_pose_pb.Pose, 15));
};
